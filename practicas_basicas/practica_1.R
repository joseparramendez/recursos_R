...
# 9
# 10
#?Que paso? Se comentaron todas las lineas seleccionadas
#?Que hace? Inserta el simbolo # al inicio de cada una de las lineas
q() 
#----Ayuda----
help(solve)
help("[[")
...
a=2
a<-3
a->6#?Que paso? Se produjo un error, quiza por un intento de asignacion por el lado izquierdo
a<-c(1,2,3,4)
?c()
class(a)
a<-cbind(a,"YADIRA")
...
(a)
x<-5
x+a#?Que paso? Se produjo un error, esto quiza debido a que se trata de distintos objetos. Ya que a contiene caacteres
y=x*x
x+y
y-x
z=y-x
